class UsuariosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to usuarios_url, notice: "Usuario foi removido." }
  ...
  private
    ...
    def usuario_params
      params.require(:usuario).permit(:customerID, :customer_name, :data_nascimento, :primary_email_address)
    end
end
